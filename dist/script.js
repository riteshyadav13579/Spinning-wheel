...
var padding = {top:0, right:0, bottom:0, left:0},
        ...
        var data = [
                    {"label":"10", "value":1, "xp":"10 "},
                    {"label":"30", "value":1, "xp":"30 "},
                    {"label":"40", "value":1, "xp":"40 "},
                    {"label":"60", "value":1, "xp":"60 "},
                    {"label":"80", "value":1, "xp":"80 "},
		...
		function spin(d){
            ...
            vis.transition()
                ...
                .each("end", function(){
                    ...
                    valueofwinner1 = parseInt(valueofwinner)    
                    
                    post(valueofwinner1,email,name1);
       ...
       function post(valueofwinner1, email, name1){
            var myHeaders = new Headers();
            myHeaders.append(
              "Authorization",
              "Basic TEROTnNNT2cyQndqdW8xaTk3bTc6eA=="
            );
            ...
            fetch(
              "https://iconnect-instance.freshservice.com/api/v2/objects/27000042948/records",
              requestOptions
            )
